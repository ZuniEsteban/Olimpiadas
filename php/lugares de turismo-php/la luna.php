...
<body>
  <header class="header">
    ...
    <div class="div-container"><span class="span">Mas Lugares</span>
      <ul class="ul-header-ple">
        ...
        <li class="li-header-ple">
          <a href="la luna.php" class="link-header-ple elegido"><span class="span">La Luna</span></a></li>
        <li class="li-header-ple">
  ...
  <section class="producto-info">
    <div class="div-contenedor">
      <div class="imagen-cr">
        <img src="../../img/img-lugares/moon1.jpg" alt="Galaxia">
      </div>
      <div class="caract">
        <h2>¿Que es la Luna?</h2>
        <h3>
          La Luna es el único satélite natural de la Tierra. Es un cuerpo rocoso que orbita alrededor de nuestro planeta, y es visible desde la Tierra debido a la luz solar que refleja. La Luna también juega un papel importante en la estabilización del clima de la Tierra y en la creación de las mareas.
        </h3>
      </div>
    </div>
  </section>
