...
<head>
  ...
  <title>Vamos a otra Galaxia</title>
...
<body>
  <header class="header">
    ...
    <div class="div-container"><span class="span">Mas Lugares</span>
      <ul class="ul-header-ple">
        ...
        <li class="li-header-ple">
          <a href="galaxias.php" class="link-header-ple elegido"><span class="span">Galaxias</span></a></li>
        <li class="li-header-ple">
  ...
  <section class="producto-info">
    <div class="div-contenedor">
      <div class="imagen-cr">
        <img src="../../img/img-lugares/galaxy2.jpg" alt="Galaxia">
      </div>
      <div class="caract">
        <h2>¿Que son las Galaxias?</h2>
        <h3>
          Las galaxias son vastos sistemas compuestos por estrellas, gas, polvo y materia oscura, unidos por la gravedad. Pueden contener desde unos pocos millones hasta billones de estrellas, y varían en tamaño y forma, incluyendo espirales, elípticas e irregulares. Nuestra propia galaxia, la Vía Láctea, es solo una de las muchas galaxias que existen en el universo. 
        </h3>
      </div>
    </div>
  </section>
