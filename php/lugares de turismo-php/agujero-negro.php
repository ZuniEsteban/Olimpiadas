...
<head>
  ...
  <title>Vamos a un Agujero Negro</title>
...
<body>
    ...
    <div class="div-container"><span class="span">Mas Lugares</span>
      <ul class="ul-header-ple">
        <li class="li-header-ple">
          <a href="agujero-negro.php" class="link-header-ple elegido"><span class="span">Agujero Negro</span></a>
        </li>
        <li class="li-header-ple">
  ...
  <section class="producto-info">
    <div class="div-contenedor">
      <div class="imagen-cr">
        <img src="../../img/img-lugares/phoenix2.jpg" alt="Galaxia">
      </div>
      <div class="caract">
        <h2>¿Que son los Agujeros Negros?</h2>
        <h3>
          Un agujero negro es una región del espacio con una gravedad tan intensa que nada, ni siquiera la luz, puede escapar de ella. Esta intensa gravedad es causada por la compresión de materia en un espacio extremadamente pequeño. Es un lugar peligroso, pero seria una aventura extraordinaria.
        </h3>
      </div>
    </div>
  </section>
