...
<body>
  ...
  <a href="../index.php" class="index">
    ...
    <div class="div-container"><span class="span">Mas Lugares</span>
      <ul class="ul-header-ple">
        ...
        <li class="li-header-ple">
          <a href="saturno.php" class="link-header-ple elegido"><span class="span">Saturno</span></a>
        </li>
      </ul>
  ...
  <section class="producto-info">
    <div class="div-contenedor">
      <div class="imagen-cr">
        <img src="../../img/img-lugares/saturn1.jpg" alt="Galaxia">
      </div>
      <div class="caract">
        <h2>¿Que es Saturno?</h2>
        <h3>
          Saturno es el sexto planeta desde el Sol y el segundo más grande del sistema solar, conocido por su impresionante sistema de anillos. Es un gigante gaseoso, compuesto principalmente de hidrógeno y helio, con una atmósfera densa y un sistema de anillos visible desde la Tierra. 
        </h3>
      </div>
    </div>
  </section>
