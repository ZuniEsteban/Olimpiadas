...
<body>
  ...
  <a href="../index.php" class="index">
    ...
    <div class="div-container"><span class="span">Mas Lugares</span>
      <ul class="ul-header-ple">
        ...
        <li class="li-header-ple">
          <a href="neptuno.php" class="link-header-ple elegido"><span class="span">Neptuno</span></a></li>
        <li class="li-header-ple">
  ...
  <section class="producto-info">
    <div class="div-contenedor">
      <div class="imagen-cr">
        <img src="../../img/img-lugares/nep1.jpg" alt="Galaxia">
      </div>
      <div class="caract">
        <h2>¿Que es Neptuno?</h2>
        <h3>
          Neptuno es el octavo planeta del Sistema Solar, el más alejado del Sol, y un gigante de hielo y gas. Es conocido por su color azul, debido a la presencia de metano en su atmósfera, y por sus fuertes vientos y tormentas. Neptuno fue el primer planeta descubierto gracias a predicciones matemáticas.         </h3>
      </div>
    </div>
  </section>
