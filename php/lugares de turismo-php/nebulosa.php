...
<head>
  ...
  <title>Vamos a una Nebulosa</title>
...
<body>
  ...
  <a href="../index.php" class="index">
    ...
    <div class="div-container"><span class="span">Mas Lugares</span>
      <ul class="ul-header-ple">
        ...
        <li class="li-header-ple">
          <a href="marte.php" class="link-header-ple"><span class="span">Marte</span></a></li>
        <li class="li-header-ple">
          <a href="nebulosa.php" class="link-header-ple elegido"><span class="span">Nebulosa</span></a></li>
        <li class="li-header-ple">
  ...
  <section class="producto-info">
    <div class="div-contenedor">
      <div class="imagen-cr">
        <img src="../../img/img-lugares/nebula4.jpg" alt="Galaxia">
      </div>
      <div class="caract">
        <h2>¿Que son las Nebulosas?</h2>
        <h3>
          Las nebulosas son grandes nubes de gas y polvo en el espacio, compuestas principalmente por hidrógeno y helio, además de otros elementos y polvo cósmico. Son lugares donde nacen y mueren estrellas, y se pueden clasificar en diferentes tipos según su composición y origen.         </h3>
      </div>
    </div>
  </section>
